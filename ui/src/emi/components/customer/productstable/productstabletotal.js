                    ...
                    <ul className='navbar-nav'>
                        ...
                        }
                        {
                            this.props.posExceeded ?
                                (<li className='nav-item' data-toggle='tooltip' data-placement='top' title='The total price for POS exceeded...'><a className='nav-link active'>POS amount to order: <span style={{fontSize: '120%', color: '#e72626'}}>{this.props.posAmountToOrder.toFixed(3)}&#8364;</span></a></li>) :
                                (<li className='nav-item'><a className='nav-link active'>POS amount to order: <span style={{fontSize: '120%'}}>{Number((this.props.posAmountToOrder / 100).toFixed(3))}&#8364;</span></a></li>)
                        }
                        <li className='nav-item'><a className='nav-link active'>Total without discount: <span style={{fontSize: '120%'}}>{Number((this.props.totalWithoutDiscount / 100).toFixed(3))}&#8364;</span></a></li>
                        <li className='nav-item'><a className='nav-link active'>Total with discount: <span style={{fontSize: '120%'}}>{Number((this.props.totalWithDiscount / 100).toFixed(3))}&#8364;</span></a></li>
