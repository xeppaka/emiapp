        ...
        return (
            <nav className='navbar fixed-bottom navbar-toggleable-sm navbar-inverse bg-inverse'>
                ...
                <ul className='navbar-nav'>
                    ...
                    <li className='nav-item' style={{marginRight: '10px'}}><button type='button' className='btn btn-secondary' onClick={(event) => this.onResetProductModifications()}>Reset</button></li>
