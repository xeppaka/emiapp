                    ...
                    this.props.modals.map((modal, idx) => {
                        ...
                        switch (modal.type) {
                            ...
                            case 'CREATE_PRODUCT_MODAL':
                                return <CreateProductModal key={modal.id} onHideModal={() => this.props.onHideModal(modal.id)} modalId={modal.id} zIndex={zIndex} />;
                            case 'CREATE_CATEGORY_MODAL':
                                return <CreateCategoryModal key={modal.id} onHideModal={() => this.props.onHideModal(modal.id)} modalId={modal.id} zIndex={zIndex} />;
